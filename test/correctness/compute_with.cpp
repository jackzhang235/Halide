...
int rgb_yuv420_test() {
    ...
    uint64_t load_count_ref, store_count_ref;
    {
        ...
        v_part(x, y) = 0;//rgb_x(2 * x, 2 * y, 0) - rgb_x(2 * x, 2 * y, 1) - rgb_x(2 * x, 2 * y, 2);
...

    {
        ...
        y_part(x, y) = rgb_x(x, y, 0);// + input(x, y, 0) + input(x, y, 1) + input(x, y, 2);
        u_part(x, y) = 0;//rgb_x(2 * x, 2 * y, 0);// - rgb_x(2 * x, 2 * y, 1) + rgb_x(2 * x, 2 * y, 2);
        v_part(x, y) = 0;//rgb_x(2 * x, 2 * y, 0) - rgb_x(2 * x, 2 * y, 1) - rgb_x(2 * x, 2 * y, 2);
